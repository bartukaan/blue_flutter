...
class BLEDeviceListEntry extends ListTile {
  String devicename;
  BLEDeviceListEntry(
      {@required BluetoothDevice device, int rssi, GestureTapCallback onTap, GestureLongPressCallback onLongPress, bool enabled = true})
      : super(
    onTap: onTap,
        ...
        child: DefaultTextStyle(
            style: () {
              /**/ if (rssi >= -35)
                ...
                /*code symetry*/ return TextStyle(color: Colors.redAccent);
            }(),
